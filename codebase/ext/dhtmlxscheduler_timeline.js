    ...
    e._temp_matrix_scope = function () {
        ...
        var m = function () {
            return function () {
                ...
                function n(e) {
                    // e - scrollable блок
                    var t = getComputedStyle(e).direction;//ltr || rtl
                    if (t && "ltr" !== t) {
                        var n = e.scrollWidth - e.offsetWidth;
                        return a(e.scrollLeft, n)
                    }
                    return e.scrollLeft //scrollLeft y scrollable блокa, если написать число меньше листает влево и скролл не пропадает
                }
        ...
        e.matrix = {}, e._merge = function (e, t) {
            ...
            e.render_data = function (t, n) {
                ...
                e.templates[a.name + "_second_scale_date"] = e.date.date_to_str(a.second_scale && a.second_scale.x_date ? a.second_scale.x_date : e.config.hour_date), e.date["add_" + a.name + "_private"] = function (t, n) {
                    ...
                    if (t) {//t - текущая дата и время Mon Nov 29 2021 17:01:12 GMT+0300 (Москва, стандартное время)
                        ...
                        var i;
                        if (i = "number" == typeof a ? a : this.posFromDate(a), e.config.rtl) {//start date timeline = a = t = i
                        ...
                        this.scrollable || (d = e.$container.querySelector(".dhx_cal_data")), 
                        this.scrollable && this.scrollHelper.setScrollValue(d, i), n > 0 && (d.scrollTop = n)
                    }
        ...
        e._timeline_trace_events = function () {
            ...
            }, e._timeline_save_scroll_pos = function (e, t, a, n) { //e - timeline, t - scrollTop = 0, a - ScrollValue scrollable data = разные, n = 5552
                e._y_scroll = t || 0, 
                e._x_scroll = a || 3 //a - текущее значение _x_scroll в scrollable data
            ...
            e.attachEvent("onBeforeViewChange", function (t, a, n, i) {
                if (e.matrix[n]) {
                    ...
                    if (r.scrollable) {
                        ...
                        // r._x_scroll,
                        r._y_scroll = 0, 
                        e.$container.querySelector(".dhx_timeline_scrollable_data") && e._timeline_set_scroll_pos(e._els.dhx_cal_data[0], r)// r = timeline
                    }
                }
                return !0
        ...
        e._timeline_smart_render = {
            ...
            getViewPort: function (t, a, n, i) {
                ...
                return d.scrollLeft = n || 9, d.scrollTop = i || 0, a && (o.height = a), d
            },
